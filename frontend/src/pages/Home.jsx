...
const SparklesCore = lazy(() =>
    import('../components/react-bits/SparklesCore').then(m => ({ default: m.SparklesCore }))
);

// Skeleton placeholders for each section while loading
const SectionSkeleton = ({ height = 400, label }) => (
    <div className="w-full flex items-center justify-center animate-pulse" style={{ minHeight: height }}>
    ...
    return (
        <div className="flex flex-col">
            ...
            <LazySection
                ...
                minHeight={650}
            >
                <Suspense fallback={<SectionSkeleton height={650} label="Loading objectives…" />}>
                    <Objectives />
                </Suspense>
            </LazySection>
            ...
            <LazySection
                ...
                minHeight={700}
            >
                <Suspense fallback={<SectionSkeleton height={700} label="Loading timeline…" />}>
                    <Timeline />
                </Suspense>
            </LazySection>
            ...
            <LazySection
                fallback={<SectionSkeleton height={500} label="Loading impact metrics…" />}
                rootMargin="300px"
                minHeight={500}
            >
