...
export const organizationData = {
    ...
    "ieee": {
        ...
        mission: "Dedicated to advancing technology for the ultimate benefit of humanity, IEEE strives to foster unparalleled innovation and excellence across the global landscape of engineering and applied sciences. Its mission is to empower a worldwide community of professionals to push the frontiers of technological possibility through collaboration and education, all while strictly upholding the most rigorous ethical standards.",
        vision: "Envisioning a future where technology functions as a transformative catalyst for societal progress, IEEE seeks to drive sustainable development and significantly elevate the quality of life for global populations. By architecting an ecosystem where engineering excellence is the primary driver of prosperity, the organization ensures that technological advancement remains seamlessly aligned with humanitarian goals for generations to come.",
