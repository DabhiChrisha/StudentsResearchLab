...
const OrganizationDetails = () => {
  ...
  return (
    <div
      key={orgId}
      className="pt-0 min-h-screen relative overflow-hidden"
      ...
      <section className="relative py-16 px-6 sm:px-10 lg:px-14 overflow-hidden min-h-[40vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
            ...
            >
              <img
                ...
                className={`h-full w-auto object-contain drop-shadow-md transition-all duration-500 ${
                  orgId === "ieee"
                    ? "[filter:brightness(0)_saturate(100%)_invert(7%)_sepia(88%)_saturate(4600%)_hue-rotate(213deg)_brightness(93%)_contrast(113%)]"
                    : ""
                }`}
              />
          ...
          <motion.h2
            ...
            className={`font-black mb-6 tracking-tight font-serif drop-shadow-xl whitespace-pre-line ${
              orgId === "mmpsrpc"
          ...
          <motion.p
            ...
            className={`text-lg sm:text-xl lg:text-2xl font-bold max-w-3xl font-serif italic drop-shadow-md ${
              orgId === "ieee" ? "text-[#002147]" : "text-slate-800"
            }`}
      ...
      <section className="pb-24 pt-4 px-6 sm:px-10 lg:px-14 relative">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <div className="relative p-8 sm:p-12 rounded-[2.5rem] shadow-2xl border border-white/50 bg-[#FAF8F3]/70 backdrop-blur-xl hover:-translate-y-2 transition-transform duration-500 group overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="space-y-6">
                  {data.description.map((paragraph, index) => (
                    <p
                      key={index}
                      className="text-slate-800 leading-[1.7] text-[16px] font-normal font-sans text-justify"
                    >
                      {paragraph}
                    </p>
                  ))}
          ...
          {data.stats && (
            <div className="relative mb-24 py-12 px-8 rounded-[3rem] bg-[#e9e4d9]/40 border border-white/20">
              <div
                className={`grid grid-cols-1 sm:grid-cols-2 ${data.stats.length === 3 ? "lg:grid-cols-3" : "lg:grid-cols-4"} gap-12 w-full mx-auto max-w-6xl`}
              >
                {data.stats.map((stat, index) => {
                  ...
                  const StatIcon = iconMapping[stat.icon] || Info;
                  ...
                  return (
                    ...
                    >
                      <div className="mb-4 flex justify-center text-[#00887b]/60 group-hover:text-secondary transition-colors duration-300">
                        ...
                        <StatIcon className="w-8 h-8" strokeWidth={1.5} />
                      </div>
              ...
              {data.leadership.map((person, index) => (
                ...
                >
                  <div className="flex flex-col items-center text-center mb-16 relative">
                    {person.role && (
                      <span className="text-[#00887b] font-bold text-xs uppercase tracking-[0.4em] mb-4 block">
                        {person.role}
                      </span>
                    )}
                    <h2 className="text-4xl lg:text-5xl font-black text-slate-800 font-sans leading-tight">
                      {person.header}
                    </h2>
                  ...
                  <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start w-full max-w-6xl mx-auto">
                    ...
                    <div className="w-full lg:w-[400px] flex flex-col items-center shrink-0">
                      ...
                      <div className="text-center w-full px-4 mt-2">
                        <h4 className="text-2xl font-black text-slate-900 font-sans mb-1">
                          {person.name}
                        </h4>
                        <p className="text-xs text-secondary-dark font-bold uppercase tracking-[0.3em] font-sans">
                          {person.designation}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex-grow flex flex-col justify-start self-start lg:pt-0 pt-0 z-10 px-4 sm:px-8">
                      <div className="mb-4 relative">
                        <div className="relative">
                          <span className="absolute -top-3 -left-6 text-3xl text-[#00887b]/30 font-serif italic select-none">
                            “
                          </span>
                          <div className="text-base lg:text-lg text-slate-900 font-bold leading-relaxed font-serif italic relative z-10 pr-6">
                            <span className="inline">
                              {person.mainQuote.trim()}
                            </span>
                            <span className="inline text-3xl text-[#00887b]/30 font-serif italic leading-none ml-1">
                              ”
                            </span>
                          </div>
                        </div>
            ...
            data.founders && (
              <div className="mb-24 relative pt-12">
                <div className="flex flex-col items-center mb-20">
                  <span className="text-[#00887b] font-bold text-xs uppercase tracking-[0.4em] mb-4">
                    Dedicated to
                  </span>
                  <h2 className="text-4xl lg:text-5xl font-black text-slate-900 text-center font-sans">
                  ...
                  {data.founders.map((founder, index) => (
                    ...
                    >
                      ...
                      <div className="text-slate-500 font-sans text-lg leading-relaxed text-center px-4 py-6 border-t border-b border-[#00887b]/10 relative">
                        <span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#F5F1E8] px-3 text-[#00887b]/40 font-serif text-3xl">
                          “
                        </span>
                        {founder.quote}
                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 bg-[#F5F1E8] px-3 text-[#00887b]/40 font-serif text-3xl rotate-180">
                          “
                        </span>
                      </div>
                    </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-32">
              {data.mission && (
                ...
                >
                  ...
                  <p className="text-slate-700 leading-[1.7] text-[16px] font-normal font-sans">
                    {data.mission}
                  </p>
                </motion.div>
              )}
          ...
          {(data.features || data.advantages) && (
            <div className="mb-32">
              ...
              <div
                className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ${orgId === "svkm" || orgId === "ksv" ? "mt-8" : ""}`}
              >
                {(data.features || data.advantages).map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <span className="font-bold text-slate-900 uppercase tracking-[0.2em] text-[11px] font-sans leading-none block mb-2">
                          {title}
                        </span>
                        {description && (
          ...
          {data.execom && (
            <div className="mb-32">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-12">
                {["IEEE KSV SB", "IEEE KSV SPS", "IEEE KSV WIE"].map(
                  (filter) => (
                    <button
                      key={filter}
          ...
          {data.contact && (
            ...
            >
              <div className="text-center mb-16 px-4">
                ...
                <h2 className="text-4xl lg:text-5xl font-black text-slate-900 font-sans tracking-tight">
                  Contact & Location
                </h2>
              ...
              <div className="grid lg:grid-cols-5 gap-0 rounded-[3rem] overflow-hidden shadow-2xl border border-white border-opacity-30">
                {/* Left Content Panel */}
                <div
                  className="lg:col-span-2 p-12 flex flex-col justify-between"
                ...
                >
                  <div className="space-y-12">
                    <div className="flex items-start gap-6 group">
                      <div className="shrink-0 w-12 h-12 rounded-2xl bg-[#F5F1E8] border border-[#00887b]/10 flex items-center justify-center group-hover:bg-[#00887b] group-hover:text-white transition-all duration-500">
                        <svg
                          className="w-5 h-5 text-[#00887b] group-hover:text-white"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div>
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#00887b]/60 mb-2">
                          {" "}
                          Location
                        </p>
                        <p className="text-slate-800 text-lg leading-relaxed font-sans italic">
                    ...
                    <div className="flex items-start gap-6 group">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-xl font-sans text-secondary-dark hover:text-secondary hover:underline transition-all"
                        >
                          {data.contact.email}
                        </a>
                      </div>
                  ...
                  <div className="mt-12 pt-8 border-t border-[#00887b]/10">
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#00887b]/60 mb-6">
                      Social Connect
                    </p>
