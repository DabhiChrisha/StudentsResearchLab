...
export const organizationData = {
    ...
    "ieee": {
        ...
        mission: "IEEE, the Institute of Electrical and Electronics Engineers, is dedicated to advancing technology for the benefit of humanity. The organization strives to foster innovation and excellence in engineering and applied sciences across the globe. IEEE's vision is to create a world where technology serves as a powerful tool for societal progress, driving sustainable development and enhancing the quality of life for people worldwide. Through collaboration, education, and innovation, IEEE aims to empower professionals to push the boundaries of technological advancement while maintaining the highest ethical standards.",
        vision: "To create a world where technology is a key driver for societal progress, promoting sustainable development and enhancing the quality of life for people worldwide.",
        ...
        advantages: [
            ...
            { title: "Student Support", description: "Benefit from tailored programs for students and young professionals." }
        ],
        contact: {
            address: "LDRP-ITR Campus, Kadi Sarva Vishwavidyalaya, Sector-15, KH-5, Gandhinagar-382015, Gujarat, India",
            email: "info.ieeeksv@gmail.com",
            phone: "+91 9408801690",
