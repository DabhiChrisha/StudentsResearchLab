...
const mamPhoto = "https://res.cloudinary.com/dtcslekyh/image/upload/v1781216785/srl_website/faculty/dr-himani-trivedi.webp";
  ...
  return (
    <section className="relative pt-12 pb-24 overflow-hidden bg-[#f0f9f6]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-[10%] left-[5%] w-64 h-64 bg-[#05877a]/5 rounded-full blur-[60px] animate-float-slower"
          style={{ willChange: "transform" }}
        />
        <div
          className="absolute bottom-[20%] right-[15%] w-96 h-96 bg-[#05877a]/10 rounded-full blur-[100px] animate-float-slow"
          style={{ willChange: "transform" }}
        />
        <div
          className="absolute top-[40%] left-[-5%] w-48 h-48 bg-[#f8e6c1]/40 rounded-full blur-[50px] animate-float-slower"
          style={{ willChange: "transform" }}
        />
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
          <svg
            ...
            className="relative block w-[120%] h-20 md:h-32 lg:h-40 -ml-[10%]"
          >
            <path
